...
export class RedaccionComponent {
  readonly structure = [
    ...
    { num: '3', section: 'Metodología', pages: '1.75',
      content: 'Diseño, escenarios, splits, procedimiento, métricas, control de sesgos.',
      include: ['Diseño experimental', 'Escenarios simulados con detalles', 'Partición train/val/OOD', 'Procedimiento paso a paso', 'Métricas justificadas', 'Sección de sesgos'],
      avoid: ['Omitir versiones/seeds', 'Muestreo sin justificar', 'Sin análisis estadístico', 'No mencionar sesgos (sim2real)'] },
