...
export class LandingComponent {
  ...
  readonly stats: StatCard[] = [
    ...
    {
      id: 'dart', label: 'Factor β · DART', staticValue: '2.2–4.9', delay: 150,
      desc: 'Transferencia de momento (2022)',
      modalTitle: 'DART 2022 · factor β = 2.2 – 4.9',
      modalSubtitle: 'La evidencia real que motiva el tema',
      modalCite: 'Momentum transfer from the DART mission kinetic impact on asteroid Dimorphos.',
      modalCiteSource: 'Cheng et al. (2023), Nature 616:457–460',
      modalBody: 'En septiembre de 2022 la misión DART de la NASA impactó el asteroide Dimorphos y midió una alteración real de su órbita: una reducción de 2.70 ± 0.10 mm/s en su velocidad orbital, con un factor de transferencia de momento β entre 2.2 y 4.9. Demostró que un impactador cinético es una estrategia de mitigación viable —pero la fase terminal exige guiado autónomo a bordo.',
      modalCta: { label: 'Ir a Motivación →', route: '/motivacion' },
    },
    {
  ...
  readonly modules: ModuleLink[] = [
    ...
    { route: '/metodologia',   number: '03', title: 'Metodología',   criterio: 'C3',
      description: 'Diseño, escenarios simulados, train/val/OOD, baselines, sesgos.' },
    { route: '/redaccion',     number: '04', title: 'Redacción',     criterio: 'C4',
      description: 'Estructura del documento académico final.' },
    { route: '/entregables',   number: '05', title: 'Entregables',
      description: 'Documento .docx, repositorio y sitio web.' },
    { route: '/laboratorio',   number: '06', title: 'Laboratorio',
      description: 'Demos en vivo: calculadora Wilcoxon, validador de hipótesis y comentarios.' },
    { route: '/autor',         number: '07', title: 'Autor',
      description: 'Quién está detrás de la propuesta · stack y despliegue del sitio.' },
  ];
}
