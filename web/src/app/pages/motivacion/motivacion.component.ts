      ...
      <div class="grid gap-6 lg:grid-cols-3">
        ...
        <div class="lg:col-span-2 space-y-6">
          <article class="card">
            ...
            <p class="text-sage-700 leading-relaxed mb-4">
              ...
              <strong class="text-brand-500">entre 12 y 18 puntos</strong>
            ...
            <div class="space-y-3">
              <div class="rounded-lg border border-sage-200 bg-sage-50/50 p-4">
                <div class="flex items-center justify-between gap-3">
                  <div class="font-display font-medium text-brand-500">BETO + fine-tuning multilingual</div>
                  <span class="chip mono">F1 0.84 (ES-ES)</span>
                </div>
                <p class="mt-1 text-sm text-sage-600">Línea base reportada en HatEval 2019, no evalúa dialectos LatAm.</p>
              </div>
              <div class="rounded-lg border border-sage-200 bg-sage-50/50 p-4">
                <div class="flex items-center justify-between gap-3">
                  <div class="font-display font-medium text-brand-500">XLM-RoBERTa-large zero-shot LatAm</div>
                  <span class="chip mono">F1 0.71 (MX)</span>
                </div>
                <p class="mt-1 text-sm text-sage-600">Sin fine-tuning dialectal — base de comparación realista del problema.</p>
              </div>
              <div class="rounded-lg border border-sage-200 bg-sage-50/50 p-4">
                <div class="flex items-center justify-between gap-3">
                  <div class="font-display font-medium text-brand-500">RoBERTuito + adaptación dominio</div>
                  <span class="chip mono">F1 0.78 (AR)</span>
                </div>
                <p class="mt-1 text-sm text-sage-600">Mejor para rioplatense, no validado en español mexicano.</p>
              </div>
            </div>
          </article>
          ...
          <article class="card">
            ...
            <ul class="space-y-2 text-sage-700">
              <li class="flex gap-3">
                <span class="text-forest-500 mono shrink-0">·</span>
        ...
        <aside class="space-y-4">
          <div class="card border-forest-500/30">
            ...
            <p class="text-sm text-sage-700 leading-relaxed">
              <strong class="text-brand-500">Criterio 1 — 20%.</strong>
          ...
          <div class="card">
            <div class="text-xs uppercase tracking-wider text-sage-500 font-ui mb-2">Referencias clave</div>
            <ol class="text-xs space-y-2 text-sage-600 mono leading-relaxed">
